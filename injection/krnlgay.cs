...
namespace injection
{
	public class krnlgay
	{
		...
		public sealed class DllInjector
		{
			...
			public krnlgayResult Inject(string sDllPath, int PID, bool threadject = false)
			{
				if (File.Exists(sDllPath))
				{
					if (!threadject)
					{
						...
						if (num != 0)
						{
							...
							{
								return krnlgayResult.Failed;
							}
							return krnlgayResult.Success;
						}
						return krnlgayResult.ProcessNotFound;
					}
					return krnlgayResult.threaderr;
				}
				return krnlgayResult.DllNotFound;
			}
		}
